...
-- Insert roles
INSERT INTO roles (id, name, description, is_active, is_system_role, created_at, updated_at) VALUES
    (uuid_generate_v4(), 'System_Admin', 'Super Administrator with full system access', true, true, NOW(), NOW()),
    (uuid_generate_v4(), 'HR_Manager', 'Human Resources Manager', true, false, NOW(), NOW()),
    (uuid_generate_v4(), 'HR_Specialist', 'Human Resources Specialist', true, false, NOW(), NOW()),
    (uuid_generate_v4(), 'WFM_Manager', 'Workforce Management Manager', true, false, NOW(), NOW()),
    (uuid_generate_v4(), 'WFM_Planner', 'Workforce Management Planner', true, false, NOW(), NOW()),
    (uuid_generate_v4(), 'Employee', 'Regular Employee', true, false, NOW(), NOW())
...
-- Insert sample users
INSERT INTO users (id, email, password, first_name, last_name, is_active, is_email_verified, created_at, updated_at) VALUES
    (uuid_generate_v4(), 'admin@example.com', '$2b$12$.JH1ZzH1E.ghESHGWDPwGuN8Oo7vhc7kuW256PFju5m3NZOdDtatC', 'Admin', 'User', true, true, NOW(), NOW()),
    (uuid_generate_v4(), 'hr.manager@example.com', '$2b$12$.JH1ZzH1E.ghESHGWDPwGuN8Oo7vhc7kuW256PFju5m3NZOdDtatC', 'HR', 'Manager', true, true, NOW(), NOW()),
    (uuid_generate_v4(), 'wfm.manager@example.com', '$2b$12$.JH1ZzH1E.ghESHGWDPwGuN8Oo7vhc7kuW256PFju5m3NZOdDtatC', 'WFM', 'Manager', true, true, NOW(), NOW()),
    (uuid_generate_v4(), 'employee@example.com', '$2b$12$.JH1ZzH1E.ghESHGWDPwGuN8Oo7vhc7kuW256PFju5m3NZOdDtatC', 'John', 'Doe', true, true, NOW(), NOW())
